CREATE PROCEDURE [dbo].[sp_report_DailyFlashOPCharges]
    (
        @divisionId int = 0,
        @reportDate DATETIME,
		@qtd BIT = 0
...
BEGIN
	...
	declare @op_charges decimal(18, 2)

	declare cur cursor fast_forward read_only for
	select coid, flash_rollup_to_coid, op_charges
	from @summary s
	...
	fetch next from cur
	into @coid, @flash_rollup_to_coid, @op_charges

	while @@fetch_status = 0
		begin
			update @summary
			set op_charges = op_charges + @op_charges
