CREATE TABLE [dbo].[PCR_HOSPITAL_MONTHLY_CHECKLIST] (
    ...
    [CREATE_DATE]                       DATETIME       CONSTRAINT [DF_PCR_HOSPITAL_CHECKLIST_CREATE_DATE] DEFAULT (getdate()) NOT NULL,
    [COMMENT]                           VARCHAR (1000) NULL,
    [COMMENT_USER_ID]                   INT            NULL,
    [COMMENT_USER_NAME]                 VARCHAR (50)   NULL,
    [COMMENT_DATE]                      DATETIME       NULL,
    [DOCUMENT_NAME]                     VARCHAR (100)  NULL,
    [IS_DOCUMENTATION_REQUIRED]         BIT            CONSTRAINT [DF_PCR_HOSPITAL_MONTHLY_CHECKLIST_IS_DOCUMENTATION_REQUIRED] DEFAULT ((0)) NOT NULL,
    [IS_COMMENT_REQUIRED]               BIT            CONSTRAINT [DF_PCR_HOSPITAL_MONTHLY_CHECKLIST_IS_COMMENT_REQUIRED] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_PCR_HOSPITAL_CHECKLIST] PRIMARY KEY CLUSTERED ([PCR_HOSPITAL_MONTHLY_CHECKLIST_ID] ASC),
    CONSTRAINT [FK_PCR_HOSPITAL_CHECKLIST_Facility] FOREIGN KEY ([COID]) REFERENCES [dbo].[Facility] ([COID])
);
